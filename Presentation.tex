...
\tab \footnotesize Strong conclusions concering a user interface\\
\tab \footnotesize Better search mechanisms\\
\tab \footnotesize Strong results on machine translation\\
\end{itemize}
}
